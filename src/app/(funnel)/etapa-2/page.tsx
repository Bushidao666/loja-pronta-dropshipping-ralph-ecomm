            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <p className="text-base text-white/70 mb-2">Enquanto você pesquisa o "método perfeito"...</p>
              ...
              <div className="flex items-start">
                <div className="w-1.5 self-stretch bg-green-500 mr-4 rounded-full min-h-[60px]"></div>
                <div className="flex-1">
                  <p className="text-base text-white/70 mb-2">Enquanto você "estuda" dropshipping...</p>
                  <div className="bg-black/30 py-3 px-4 rounded-lg border-l-2 border-green-500">
                    <p className="text-lg sm:text-xl font-medium text-white">
