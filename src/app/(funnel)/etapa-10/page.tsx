...
export default function Etapa10Page() {
  const listItems = [
    "Sair do aluguel e financiar a casa própria",
    "Trocar de carro sem se endividar",
    "Ter uma reserva de emergência",
    "Dormir tranquilo sem se preocupar com dinheiro"
  ];
        ...
        <div className="w-full max-w-4xl space-y-6">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center leading-tight">
              O Que Você Faria <span className="text-green-400">Com Essa Grana?</span>
            </h1>
          </motion.div>
