        ...
        <div className="w-full max-w-4xl space-y-6">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center leading-tight">
              Como Você <span className="text-green-400">Se Sentiria?</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-white text-center pt-4">
              <span className="font-bold">Isso não é sonho.</span><br/>
              <span className="font-bold text-green-400">É realidade para quem age.</span>
            </p>
          </motion.div>
        </div>
      </div>
